	...
	public static void responseCodeValidation(Response response, int statusCode) {
		...
		try {
			...
			test.log(LogStatus.FAIL,
					"Expected status code is :: " + statusCode + " , but getting :: " + response.getStatusCode());
		} catch (Exception e) {
			test.log(LogStatus.FAIL, e.fillInStackTrace());
		}
	}
	
	public static void responseCodeValidationWithoutCatch(Response response, int statusCode) {
